...
3. **Chronological Detection Latency**: On the controlled synthetic benchmark suite, FABLE achieves a 1.0h mean detection lead time / latency across synthetic attack scenarios.
